...
#define __PYX_HAVE__convolusion
#define __PYX_HAVE_API__convolusion
/* Early includes */
#include <string.h>
#include <stdio.h>
 ...
 */
typedef __pyx_t_5numpy_int_t __pyx_t_11convolusion_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'convolusion' */
static PyObject *__pyx_f_11convolusion_convolve(PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_11convolusion_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_11convolusion_DTYPE_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_11convolusion_DTYPE_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_11convolusion_DTYPE_t), 0 };
#define __Pyx_MODULE_NAME "convolusion"
extern int __pyx_module_is_main_convolusion;
int __pyx_module_is_main_convolusion = 0;

/* Implementation of 'convolusion' */
...
static PyObject *__pyx_pf_11convolusion_convolve(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_image, PyArrayObject *__pyx_v_kernel); /* proto */
 ...
 * 
 * cpdef convolve(np.ndarray[DTYPE_t, ndim=2] image, np.ndarray[DTYPE_t, ndim=2] kernel):             # <<<<<<<<<<<<<<
 * 
 *     if kernel.shape[0] % 2 != 1 or kernel.shape[1] % 2 != 1:
 */

static PyObject *__pyx_pw_11convolusion_1convolve(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_11convolusion_convolve(PyArrayObject *__pyx_v_image, PyArrayObject *__pyx_v_kernel, CYTHON_UNUSED int __pyx_skip_dispatch) {
  Py_ssize_t __pyx_v_image_row;
  Py_ssize_t __pyx_v_image_col;
  Py_ssize_t __pyx_v_kernel_row;
  Py_ssize_t __pyx_v_kernel_col;
  Py_ssize_t __pyx_v_smid;
  Py_ssize_t __pyx_v_tmid;
  Py_ssize_t __pyx_v_xmax;
  Py_ssize_t __pyx_v_ymax;
  ...
  Py_ssize_t __pyx_v_s_from;
  Py_ssize_t __pyx_v_s_to;
  Py_ssize_t __pyx_v_t_from;
  Py_ssize_t __pyx_v_t_to;
  __pyx_t_11convolusion_DTYPE_t __pyx_v_value;
  ...
  __pyx_pybuffernd_kernel.rcbuffer = &__pyx_pybuffer_kernel;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_image.rcbuffer->pybuffer, (PyObject*)__pyx_v_image, &__Pyx_TypeInfo_nn___pyx_t_11convolusion_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_kernel.rcbuffer->pybuffer, (PyObject*)__pyx_v_kernel, &__Pyx_TypeInfo_nn___pyx_t_11convolusion_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 11, __pyx_L1_error)
  }
 ...
 *     assert kernel.dtype == DTYPE and kernel.dtype == DTYPE
 */
  __pyx_t_2 = ((__Pyx_mod_long((__pyx_v_kernel->dimensions[0]), 2) != 1) != 0);
  if (!__pyx_t_2) {
  } else {
    __pyx_t_1 = __pyx_t_2;
    goto __pyx_L4_bool_binop_done;
  }
  __pyx_t_2 = ((__Pyx_mod_long((__pyx_v_kernel->dimensions[1]), 2) != 1) != 0);
  __pyx_t_1 = __pyx_t_2;
 ...
 *     assert kernel.dtype == DTYPE and kernel.dtype == DTYPE             # <<<<<<<<<<<<<<
 * 
 *     cdef Py_ssize_t image_row = image.shape[0]
 */
  #ifndef CYTHON_WITHOUT_ASSERTIONS
  if (unlikely(!Py_OptimizeFlag)) {
    __pyx_t_3 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_kernel), __pyx_n_s_dtype); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_DTYPE); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_5 = PyObject_RichCompare(__pyx_t_3, __pyx_t_4, Py_EQ); __Pyx_XGOTREF(__pyx_t_5); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_2 = __Pyx_PyObject_IsTrue(__pyx_t_5); if (unlikely(__pyx_t_2 < 0)) __PYX_ERR(0, 15, __pyx_L1_error)
    ...
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(((PyObject *)__pyx_v_kernel), __pyx_n_s_dtype); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_GetModuleGlobalName(__pyx_t_4, __pyx_n_s_DTYPE); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __pyx_t_3 = PyObject_RichCompare(__pyx_t_5, __pyx_t_4, Py_EQ); __Pyx_XGOTREF(__pyx_t_3); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 15, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
 ...
 * 
 *     cdef Py_ssize_t image_row = image.shape[0]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t image_col = image.shape[1]
 *     cdef Py_ssize_t kernel_row = kernel.shape[0]
 */
  __pyx_v_image_row = (__pyx_v_image->dimensions[0]);
 ...
 *     cdef Py_ssize_t image_col = image.shape[1]             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t kernel_row = kernel.shape[0]
 *     cdef Py_ssize_t kernel_col = kernel.shape[1]
 */
  __pyx_v_image_col = (__pyx_v_image->dimensions[1]);
 ...
 * 
 */
  __pyx_v_kernel_row = (__pyx_v_kernel->dimensions[0]);
 ...
 *     cdef Py_ssize_t kernel_col = kernel.shape[1]             # <<<<<<<<<<<<<<
 * 
 *     cdef Py_ssize_t smid = kernel_row // 2
 */
  __pyx_v_kernel_col = (__pyx_v_kernel->dimensions[1]);

  /* "convolusion.pyx":22
 *     cdef Py_ssize_t kernel_col = kernel.shape[1]
 * 
 *     cdef Py_ssize_t smid = kernel_row // 2             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t tmid = kernel_col // 2
 *     cdef Py_ssize_t xmax = image_row + 2 * smid
 */
  __pyx_v_smid = __Pyx_div_Py_ssize_t(__pyx_v_kernel_row, 2);
 ...
 *     cdef Py_ssize_t tmid = kernel_col // 2             # <<<<<<<<<<<<<<
 *     cdef Py_ssize_t xmax = image_row + 2 * smid
 *     cdef Py_ssize_t ymax = image_col + 2 * tmid
 */
  __pyx_v_tmid = __Pyx_div_Py_ssize_t(__pyx_v_kernel_col, 2);
 ...
 * 
 */
  __pyx_v_xmax = (__pyx_v_image_row + (2 * __pyx_v_smid));
 ...
 *     cdef Py_ssize_t ymax = image_col + 2 * tmid             # <<<<<<<<<<<<<<
 * 
 *     cdef np.ndarray[DTYPE_t, ndim=2] output = np.empty([xmax, ymax], dtype=DTYPE)
 */
  __pyx_v_ymax = (__pyx_v_image_col + (2 * __pyx_v_tmid));
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_empty); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyInt_FromSsize_t(__pyx_v_xmax); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = PyInt_FromSsize_t(__pyx_v_ymax); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_output.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_11convolusion_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {
 ...
 */
      ...
      __pyx_t_16 = (__pyx_v_tmid - __pyx_v_y);
 ...
 */
      ...
      __pyx_t_14 = __pyx_t_16;
      for (__pyx_t_15 = __pyx_v_s_from; __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
 ...
 *                     w = y - tmid + t
 */
        __pyx_t_17 = __pyx_v_t_to;
        __pyx_t_18 = __pyx_t_17;
        for (__pyx_t_19 = __pyx_v_t_from; __pyx_t_19 < __pyx_t_18; __pyx_t_19+=1) {
 ...
 * 
 */
          __pyx_t_20 = (__pyx_v_smid - __pyx_v_s);
          __pyx_t_21 = (__pyx_v_tmid - __pyx_v_t);
          __pyx_t_22 = __pyx_v_v;
          __pyx_t_23 = __pyx_v_w;
          __pyx_v_value = (__pyx_v_value + ((*__Pyx_BufPtrStrided2d(__pyx_t_11convolusion_DTYPE_t *, __pyx_pybuffernd_kernel.rcbuffer->pybuffer.buf, __pyx_t_20, __pyx_pybuffernd_kernel.diminfo[0].strides, __pyx_t_21, __pyx_pybuffernd_kernel.diminfo[1].strides)) * (*__Pyx_BufPtrStrided2d(__pyx_t_11convolusion_DTYPE_t *, __pyx_pybuffernd_image.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_image.diminfo[0].strides, __pyx_t_23, __pyx_pybuffernd_image.diminfo[1].strides))));
        }
      }
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_11convolusion_DTYPE_t *, __pyx_pybuffernd_output.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_output.diminfo[0].strides, __pyx_t_22, __pyx_pybuffernd_output.diminfo[1].strides) = __pyx_v_value;
    }
  }
 ...
 */
  ...
  __Pyx_AddTraceback("convolusion.convolve", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_image.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_11convolusion_1convolve(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11convolusion_1convolve(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_kernel)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("convolve", 1, 2, 2, 1); __PYX_ERR(0, 11, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "convolve") < 0)) __PYX_ERR(0, 11, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("convolve", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 11, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("convolusion.convolve", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_kernel), __pyx_ptype_5numpy_ndarray, 1, "kernel", 0))) __PYX_ERR(0, 11, __pyx_L1_error)
  __pyx_r = __pyx_pf_11convolusion_convolve(__pyx_self, __pyx_v_image, __pyx_v_kernel);
...
static PyObject *__pyx_pf_11convolusion_convolve(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_image, PyArrayObject *__pyx_v_kernel) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_image;
  __Pyx_Buffer __pyx_pybuffer_image;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_kernel;
  __Pyx_Buffer __pyx_pybuffer_kernel;
  ...
  __pyx_pybuffernd_kernel.diminfo[0].strides = __pyx_pybuffernd_kernel.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_kernel.diminfo[0].shape = __pyx_pybuffernd_kernel.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_kernel.diminfo[1].strides = __pyx_pybuffernd_kernel.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_kernel.diminfo[1].shape = __pyx_pybuffernd_kernel.rcbuffer->pybuffer.shape[1];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_11convolusion_convolve(__pyx_v_image, __pyx_v_kernel, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 11, __pyx_L1_error)
...
static PyMethodDef __pyx_methods[] = {
  {"convolve", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11convolusion_1convolve, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_convolusion(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_convolusion},
  {0, NULL}
};
#endif
 ...
 * 
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Only_odd_dimensions_on_filter_su); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 14, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initconvolusion(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initconvolusion(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_convolusion(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_convolusion(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_convolusion(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'convolusion' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_convolusion(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("convolusion", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_convolusion) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "convolusion")) {
      if (unlikely(PyDict_SetItemString(modules, "convolusion", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init convolusion", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init convolusion");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
