...
static PyObject *__pyx_pw_9pix_count_1pixel_count(PyObject *__pyx_self, PyObject *__pyx_arg_image) {
  ...
  assert(__pyx_arg_image); {
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(__pyx_arg_image, PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 7, __pyx_L3_error)
  }
...
static PyObject *__pyx_pf_9pix_count_pixel_count(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image) {
  ...
  if (unlikely(!__pyx_v_image.memview)) { __Pyx_RaiseUnboundLocalError("image"); __PYX_ERR(0, 7, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_9pix_count_pixel_count(__pyx_v_image, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
