...
#define __PYX_HAVE__gaussian
#define __PYX_HAVE_API__gaussian
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* "../env/lib/site-packages/numpy/__init__.pxd":706
 * ctypedef npy_uint8      uint8_t
 * ctypedef npy_uint16     uint16_t
 * ctypedef npy_uint32     uint32_t             # <<<<<<<<<<<<<<
 * ctypedef npy_uint64     uint64_t
...
/* "../env/lib/site-packages/numpy/__init__.pxd":707
 * ctypedef npy_uint16     uint16_t
 * ctypedef npy_uint32     uint32_t
 * ctypedef npy_uint64     uint64_t             # <<<<<<<<<<<<<<
 * #ctypedef npy_uint96     uint96_t
...
/* "../env/lib/site-packages/numpy/__init__.pxd":711
 * #ctypedef npy_uint128    uint128_t
 * 
...
/* "../env/lib/site-packages/numpy/__init__.pxd":712
 * 
 * ctypedef npy_float32    float32_t
 * ctypedef npy_float64    float64_t             # <<<<<<<<<<<<<<
 * #ctypedef npy_float80    float80_t
 ...
 * 
 * cpdef unsigned char[:, :] gaussian_blur(unsigned char [:, :] image, int val):
 */
typedef __pyx_t_5numpy_uint_t __pyx_t_8gaussian_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'gaussian' */
...
static __Pyx_memviewslice __pyx_f_8gaussian_gaussian_blur(__Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "gaussian"
extern int __pyx_module_is_main_gaussian;
int __pyx_module_is_main_gaussian = 0;
...
static PyObject *__pyx_pf_8gaussian_gaussian_blur(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, int __pyx_v_val); /* proto */
...
static PyObject *__pyx_pw_8gaussian_1gaussian_blur(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_8gaussian_gaussian_blur(__Pyx_memviewslice __pyx_v_image, int __pyx_v_val, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_w;
  int __pyx_v_h;
  ...
  __Pyx_memviewslice __pyx_t_175 = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
 ...
 *     h = image.shape[0]             # <<<<<<<<<<<<<<
 *     w = image.shape[1]
 *     output = np.empty((h, w), dtype=np.ubyte)
 */
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_h); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_w); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 16, __pyx_L1_error)
  ...
  __Pyx_GetModuleGlobalName(__pyx_t_1, __pyx_n_s_np); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 16, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_ubyte); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 16, __pyx_L1_error)
 ...
 *             GX =  1*image[y+0,x+0]+ 0*image[y+0,x+1]+ 0*image[y+0,x+2]+ 0*image[y+0,x+3]+ 0*image[y+0,x+4]+ 0*image[y+0,x+5]+ 0*image[y+0,x+6]+ 0*image[y+0,x+7]+ 1*image[y+0,x+8]+\
 */
  __pyx_t_6 = (__pyx_v_h - 9);
  __pyx_t_7 = __pyx_t_6;
 ...
 *         for x in range(0, w-9):             # <<<<<<<<<<<<<<
 *             GX =  1*image[y+0,x+0]+ 0*image[y+0,x+1]+ 0*image[y+0,x+2]+ 0*image[y+0,x+3]+ 0*image[y+0,x+4]+ 0*image[y+0,x+5]+ 0*image[y+0,x+6]+ 0*image[y+0,x+7]+ 1*image[y+0,x+8]+\
 *                   0*image[y+1,x+0]+ 0*image[y+1,x+1]+ 0*image[y+1,x+2]+ 0*image[y+1,x+3]+ 0*image[y+1,x+4]+ 0*image[y+1,x+5]+ 0*image[y+1,x+6]+ 0*image[y+1,x+7]+ 0*image[y+1,x+8]+\
 */
    __pyx_t_9 = (__pyx_v_w - 9);
 ...
 *             GX =  1*image[y+0,x+0]+ 0*image[y+0,x+1]+ 0*image[y+0,x+2]+ 0*image[y+0,x+3]+ 0*image[y+0,x+4]+ 0*image[y+0,x+5]+ 0*image[y+0,x+6]+ 0*image[y+0,x+7]+ 1*image[y+0,x+8]+\             # <<<<<<<<<<<<<<
 *                   0*image[y+1,x+0]+ 0*image[y+1,x+1]+ 0*image[y+1,x+2]+ 0*image[y+1,x+3]+ 0*image[y+1,x+4]+ 0*image[y+1,x+5]+ 0*image[y+1,x+6]+ 0*image[y+1,x+7]+ 0*image[y+1,x+8]+\
 *                   0*image[y+2,x+0]+ 0*image[y+2,x+1]+ 0*image[y+2,x+2]+ 1*image[y+2,x+3]+ 1*image[y+2,x+4]+ 1*image[y+2,x+5]+ 0*image[y+2,x+6]+ 0*image[y+2,x+7]+ 0*image[y+2,x+8]+\
 */
      __pyx_t_12 = (__pyx_v_y + 0);
      __pyx_t_13 = (__pyx_v_x + 0);
      __pyx_t_14 = -1;
      if (__pyx_t_12 < 0) {
        __pyx_t_12 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_12 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_12 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_13 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_13 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 20, __pyx_L1_error)
      }
      __pyx_t_15 = (__pyx_v_y + 0);
      __pyx_t_16 = (__pyx_v_x + 1);
      __pyx_t_14 = -1;
      if (__pyx_t_15 < 0) {
        __pyx_t_15 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_15 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_15 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_16 < 0) {
        __pyx_t_16 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_16 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_16 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 20, __pyx_L1_error)
      }
      __pyx_t_17 = (__pyx_v_y + 0);
      __pyx_t_18 = (__pyx_v_x + 2);
      __pyx_t_14 = -1;
      if (__pyx_t_17 < 0) {
        __pyx_t_17 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_17 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_17 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_18 < 0) {
        __pyx_t_18 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_18 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_18 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 20, __pyx_L1_error)
      }
      __pyx_t_19 = (__pyx_v_y + 0);
      __pyx_t_20 = (__pyx_v_x + 3);
      __pyx_t_14 = -1;
      if (__pyx_t_19 < 0) {
      ...
      __pyx_t_21 = (__pyx_v_y + 0);
      __pyx_t_22 = (__pyx_v_x + 4);
      __pyx_t_14 = -1;
      if (__pyx_t_21 < 0) {
        __pyx_t_21 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_21 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_21 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_22 < 0) {
        __pyx_t_22 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_22 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_22 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 20, __pyx_L1_error)
      }
      __pyx_t_23 = (__pyx_v_y + 0);
      __pyx_t_24 = (__pyx_v_x + 5);
      __pyx_t_14 = -1;
      if (__pyx_t_23 < 0) {
        __pyx_t_23 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_23 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_23 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_24 < 0) {
        __pyx_t_24 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_24 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_24 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 20, __pyx_L1_error)
      }
      __pyx_t_25 = (__pyx_v_y + 0);
      __pyx_t_26 = (__pyx_v_x + 6);
      __pyx_t_14 = -1;
      if (__pyx_t_25 < 0) {
        __pyx_t_25 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_25 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_25 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_26 < 0) {
        __pyx_t_26 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_26 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_26 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 20, __pyx_L1_error)
      }
      __pyx_t_27 = (__pyx_v_y + 0);
      __pyx_t_28 = (__pyx_v_x + 7);
      __pyx_t_14 = -1;
      if (__pyx_t_27 < 0) {
        __pyx_t_27 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_27 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_27 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_28 < 0) {
        __pyx_t_28 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_28 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_28 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 20, __pyx_L1_error)
      }
      __pyx_t_29 = (__pyx_v_y + 0);
      __pyx_t_30 = (__pyx_v_x + 8);
      __pyx_t_14 = -1;
      if (__pyx_t_29 < 0) {
        __pyx_t_29 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_29 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_29 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_30 < 0) {
        __pyx_t_30 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_30 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_30 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 20, __pyx_L1_error)
      }
 ...
 *                   0*image[y+1,x+0]+ 0*image[y+1,x+1]+ 0*image[y+1,x+2]+ 0*image[y+1,x+3]+ 0*image[y+1,x+4]+ 0*image[y+1,x+5]+ 0*image[y+1,x+6]+ 0*image[y+1,x+7]+ 0*image[y+1,x+8]+\             # <<<<<<<<<<<<<<
 *                   0*image[y+2,x+0]+ 0*image[y+2,x+1]+ 0*image[y+2,x+2]+ 1*image[y+2,x+3]+ 1*image[y+2,x+4]+ 1*image[y+2,x+5]+ 0*image[y+2,x+6]+ 0*image[y+2,x+7]+ 0*image[y+2,x+8]+\
 *                   0*image[y+3,x+0]+ 0*image[y+3,x+1]+ 0*image[y+3,x+2]+ 1*image[y+3,x+3]+ 1*image[y+3,x+4]+ 1*image[y+3,x+5]+ 0*image[y+3,x+6]+ 0*image[y+3,x+7]+ 0*image[y+3,x+8]+\
 */
      __pyx_t_31 = (__pyx_v_y + 1);
      __pyx_t_32 = (__pyx_v_x + 0);
      __pyx_t_14 = -1;
      if (__pyx_t_31 < 0) {
        __pyx_t_31 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_31 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_31 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_32 < 0) {
        __pyx_t_32 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_32 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_32 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
 ...
 */
      ...
      __pyx_t_14 = -1;
      if (__pyx_t_33 < 0) {
        __pyx_t_33 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_33 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_33 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_34 < 0) {
        __pyx_t_34 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_34 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_34 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 21, __pyx_L1_error)
      }
 ...
 */
      ...
      __pyx_t_14 = -1;
      if (__pyx_t_35 < 0) {
        __pyx_t_35 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_35 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_35 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_36 < 0) {
        __pyx_t_36 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_36 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_36 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 21, __pyx_L1_error)
      }
      __pyx_t_37 = (__pyx_v_y + 1);
      __pyx_t_38 = (__pyx_v_x + 3);
      __pyx_t_14 = -1;
      if (__pyx_t_37 < 0) {
        __pyx_t_37 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_37 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_37 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_38 < 0) {
        __pyx_t_38 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_38 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_38 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 21, __pyx_L1_error)
      }
      __pyx_t_39 = (__pyx_v_y + 1);
      __pyx_t_40 = (__pyx_v_x + 4);
      __pyx_t_14 = -1;
      if (__pyx_t_39 < 0) {
        __pyx_t_39 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_39 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_39 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_40 < 0) {
        __pyx_t_40 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_40 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_40 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 21, __pyx_L1_error)
      }
      __pyx_t_41 = (__pyx_v_y + 1);
      __pyx_t_42 = (__pyx_v_x + 5);
      __pyx_t_14 = -1;
      if (__pyx_t_41 < 0) {
        __pyx_t_41 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_41 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_41 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_42 < 0) {
        __pyx_t_42 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_42 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_42 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 21, __pyx_L1_error)
      }
      __pyx_t_43 = (__pyx_v_y + 1);
      __pyx_t_44 = (__pyx_v_x + 6);
      __pyx_t_14 = -1;
      if (__pyx_t_43 < 0) {
        __pyx_t_43 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_43 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_43 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_44 < 0) {
        __pyx_t_44 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_44 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_44 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 21, __pyx_L1_error)
      }
      __pyx_t_45 = (__pyx_v_y + 1);
      __pyx_t_46 = (__pyx_v_x + 7);
      __pyx_t_14 = -1;
      if (__pyx_t_45 < 0) {
        __pyx_t_45 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_45 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_45 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_46 < 0) {
        __pyx_t_46 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_46 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_46 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 21, __pyx_L1_error)
      }
      __pyx_t_47 = (__pyx_v_y + 1);
      __pyx_t_48 = (__pyx_v_x + 8);
      __pyx_t_14 = -1;
      if (__pyx_t_47 < 0) {
        __pyx_t_47 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_47 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_47 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_48 < 0) {
        __pyx_t_48 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_48 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_48 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 21, __pyx_L1_error)
      }
 ...
 *                   0*image[y+2,x+0]+ 0*image[y+2,x+1]+ 0*image[y+2,x+2]+ 1*image[y+2,x+3]+ 1*image[y+2,x+4]+ 1*image[y+2,x+5]+ 0*image[y+2,x+6]+ 0*image[y+2,x+7]+ 0*image[y+2,x+8]+\             # <<<<<<<<<<<<<<
 *                   0*image[y+3,x+0]+ 0*image[y+3,x+1]+ 0*image[y+3,x+2]+ 1*image[y+3,x+3]+ 1*image[y+3,x+4]+ 1*image[y+3,x+5]+ 0*image[y+3,x+6]+ 0*image[y+3,x+7]+ 0*image[y+3,x+8]+\
 *                   0*image[y+4,x+0]+ 0*image[y+4,x+1]+ 0*image[y+4,x+2]+ 1*image[y+4,x+3]+ 1*image[y+4,x+4]+ 1*image[y+4,x+5]+ 0*image[y+4,x+6]+ 0*image[y+4,x+7]+ 0*image[y+4,x+8]+\
 */
      __pyx_t_49 = (__pyx_v_y + 2);
      __pyx_t_50 = (__pyx_v_x + 0);
      __pyx_t_14 = -1;
      if (__pyx_t_49 < 0) {
        __pyx_t_49 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_49 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_49 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_50 < 0) {
        __pyx_t_50 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_50 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_50 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
 ...
 *                   0*image[y+3,x+0]+ 0*image[y+3,x+1]+ 0*image[y+3,x+2]+ 1*image[y+3,x+3]+ 1*image[y+3,x+4]+ 1*image[y+3,x+5]+ 0*image[y+3,x+6]+ 0*image[y+3,x+7]+ 0*image[y+3,x+8]+\
 */
      __pyx_t_51 = (__pyx_v_y + 2);
      __pyx_t_52 = (__pyx_v_x + 1);
      __pyx_t_14 = -1;
      if (__pyx_t_51 < 0) {
        __pyx_t_51 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_51 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_51 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_52 < 0) {
        __pyx_t_52 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_52 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_52 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
 ...
 *                   0*image[y+4,x+0]+ 0*image[y+4,x+1]+ 0*image[y+4,x+2]+ 1*image[y+4,x+3]+ 1*image[y+4,x+4]+ 1*image[y+4,x+5]+ 0*image[y+4,x+6]+ 0*image[y+4,x+7]+ 0*image[y+4,x+8]+\
 */
      __pyx_t_53 = (__pyx_v_y + 2);
      __pyx_t_54 = (__pyx_v_x + 2);
      __pyx_t_14 = -1;
      if (__pyx_t_53 < 0) {
        __pyx_t_53 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_53 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_53 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_54 < 0) {
        __pyx_t_54 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_54 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_54 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      __pyx_t_55 = (__pyx_v_y + 2);
      __pyx_t_56 = (__pyx_v_x + 3);
      __pyx_t_14 = -1;
      if (__pyx_t_55 < 0) {
        __pyx_t_55 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_55 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_55 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_56 < 0) {
        __pyx_t_56 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_56 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_56 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      __pyx_t_57 = (__pyx_v_y + 2);
      __pyx_t_58 = (__pyx_v_x + 4);
      __pyx_t_14 = -1;
      if (__pyx_t_57 < 0) {
        __pyx_t_57 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_57 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_57 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_58 < 0) {
        __pyx_t_58 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_58 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_58 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      __pyx_t_59 = (__pyx_v_y + 2);
      __pyx_t_60 = (__pyx_v_x + 5);
      __pyx_t_14 = -1;
      if (__pyx_t_59 < 0) {
        __pyx_t_59 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_59 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_59 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_60 < 0) {
        __pyx_t_60 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_60 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_60 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      __pyx_t_61 = (__pyx_v_y + 2);
      __pyx_t_62 = (__pyx_v_x + 6);
      __pyx_t_14 = -1;
      if (__pyx_t_61 < 0) {
        __pyx_t_61 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_61 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_61 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_62 < 0) {
        __pyx_t_62 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_62 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_62 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      __pyx_t_63 = (__pyx_v_y + 2);
      __pyx_t_64 = (__pyx_v_x + 7);
      __pyx_t_14 = -1;
      if (__pyx_t_63 < 0) {
        __pyx_t_63 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_63 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_63 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_64 < 0) {
        __pyx_t_64 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_64 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_64 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      __pyx_t_65 = (__pyx_v_y + 2);
      __pyx_t_66 = (__pyx_v_x + 8);
      __pyx_t_14 = -1;
      if (__pyx_t_65 < 0) {
        __pyx_t_65 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_65 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_65 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_66 < 0) {
        __pyx_t_66 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_66 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_66 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
 ...
 *                   0*image[y+3,x+0]+ 0*image[y+3,x+1]+ 0*image[y+3,x+2]+ 1*image[y+3,x+3]+ 1*image[y+3,x+4]+ 1*image[y+3,x+5]+ 0*image[y+3,x+6]+ 0*image[y+3,x+7]+ 0*image[y+3,x+8]+\             # <<<<<<<<<<<<<<
 *                   0*image[y+4,x+0]+ 0*image[y+4,x+1]+ 0*image[y+4,x+2]+ 1*image[y+4,x+3]+ 1*image[y+4,x+4]+ 1*image[y+4,x+5]+ 0*image[y+4,x+6]+ 0*image[y+4,x+7]+ 0*image[y+4,x+8]+\
 *                   0*image[y+5,x+0]+ 0*image[y+5,x+1]+ 0*image[y+4,x+2]+ 1*image[y+5,x+3]+ 1*image[y+5,x+4]+ 1*image[y+5,x+5]+ 0*image[y+5,x+6]+ 0*image[y+5,x+7]+ 0*image[y+5,x+8]+\
 */
      __pyx_t_67 = (__pyx_v_y + 3);
      __pyx_t_68 = (__pyx_v_x + 0);
      __pyx_t_14 = -1;
      if (__pyx_t_67 < 0) {
        __pyx_t_67 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_67 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_67 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_68 < 0) {
        __pyx_t_68 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_68 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_68 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
 ...
 *                   0*image[y+4,x+0]+ 0*image[y+4,x+1]+ 0*image[y+4,x+2]+ 1*image[y+4,x+3]+ 1*image[y+4,x+4]+ 1*image[y+4,x+5]+ 0*image[y+4,x+6]+ 0*image[y+4,x+7]+ 0*image[y+4,x+8]+\
 */
      __pyx_t_69 = (__pyx_v_y + 3);
      __pyx_t_70 = (__pyx_v_x + 1);
      __pyx_t_14 = -1;
      if (__pyx_t_69 < 0) {
        __pyx_t_69 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_69 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_69 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_70 < 0) {
        __pyx_t_70 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_70 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_70 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 23, __pyx_L1_error)
      }
 ...
 *                   0*image[y+5,x+0]+ 0*image[y+5,x+1]+ 0*image[y+4,x+2]+ 1*image[y+5,x+3]+ 1*image[y+5,x+4]+ 1*image[y+5,x+5]+ 0*image[y+5,x+6]+ 0*image[y+5,x+7]+ 0*image[y+5,x+8]+\
 */
      __pyx_t_71 = (__pyx_v_y + 3);
      __pyx_t_72 = (__pyx_v_x + 2);
      __pyx_t_14 = -1;
      if (__pyx_t_71 < 0) {
        __pyx_t_71 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_71 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_71 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_72 < 0) {
        __pyx_t_72 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_72 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_72 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 23, __pyx_L1_error)
      }
      __pyx_t_73 = (__pyx_v_y + 3);
      __pyx_t_74 = (__pyx_v_x + 3);
      __pyx_t_14 = -1;
      if (__pyx_t_73 < 0) {
        __pyx_t_73 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_73 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_73 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_74 < 0) {
        __pyx_t_74 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_74 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_74 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 23, __pyx_L1_error)
      }
      __pyx_t_75 = (__pyx_v_y + 3);
      __pyx_t_76 = (__pyx_v_x + 4);
      __pyx_t_14 = -1;
      if (__pyx_t_75 < 0) {
        __pyx_t_75 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_75 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_75 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_76 < 0) {
        __pyx_t_76 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_76 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_76 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 23, __pyx_L1_error)
      }
      __pyx_t_77 = (__pyx_v_y + 3);
      __pyx_t_78 = (__pyx_v_x + 5);
      __pyx_t_14 = -1;
      if (__pyx_t_77 < 0) {
        __pyx_t_77 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_77 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_77 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_78 < 0) {
        __pyx_t_78 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_78 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_78 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 23, __pyx_L1_error)
      }
      __pyx_t_79 = (__pyx_v_y + 3);
      __pyx_t_80 = (__pyx_v_x + 6);
      __pyx_t_14 = -1;
      if (__pyx_t_79 < 0) {
        __pyx_t_79 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_79 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_79 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_80 < 0) {
        __pyx_t_80 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_80 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_80 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 23, __pyx_L1_error)
      }
      __pyx_t_81 = (__pyx_v_y + 3);
      __pyx_t_82 = (__pyx_v_x + 7);
      __pyx_t_14 = -1;
      if (__pyx_t_81 < 0) {
        __pyx_t_81 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_81 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_81 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_82 < 0) {
        __pyx_t_82 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_82 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_82 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 23, __pyx_L1_error)
      }
      __pyx_t_83 = (__pyx_v_y + 3);
      __pyx_t_84 = (__pyx_v_x + 8);
      __pyx_t_14 = -1;
      if (__pyx_t_83 < 0) {
        __pyx_t_83 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_83 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_83 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_84 < 0) {
        __pyx_t_84 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_84 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_84 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 23, __pyx_L1_error)
      }
 ...
 *                   0*image[y+4,x+0]+ 0*image[y+4,x+1]+ 0*image[y+4,x+2]+ 1*image[y+4,x+3]+ 1*image[y+4,x+4]+ 1*image[y+4,x+5]+ 0*image[y+4,x+6]+ 0*image[y+4,x+7]+ 0*image[y+4,x+8]+\             # <<<<<<<<<<<<<<
 *                   0*image[y+5,x+0]+ 0*image[y+5,x+1]+ 0*image[y+4,x+2]+ 1*image[y+5,x+3]+ 1*image[y+5,x+4]+ 1*image[y+5,x+5]+ 0*image[y+5,x+6]+ 0*image[y+5,x+7]+ 0*image[y+5,x+8]+\
 *                   0*image[y+6,x+0]+ 0*image[y+6,x+1]+ 0*image[y+4,x+2]+ 1*image[y+6,x+3]+ 1*image[y+6,x+4]+ 1*image[y+6,x+5]+ 0*image[y+6,x+6]+ 0*image[y+6,x+7]+ 0*image[y+6,x+8]+\
 */
      __pyx_t_85 = (__pyx_v_y + 4);
      __pyx_t_86 = (__pyx_v_x + 0);
      __pyx_t_14 = -1;
      if (__pyx_t_85 < 0) {
        __pyx_t_85 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_85 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_85 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_86 < 0) {
        __pyx_t_86 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_86 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_86 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
 ...
 *                   0*image[y+5,x+0]+ 0*image[y+5,x+1]+ 0*image[y+4,x+2]+ 1*image[y+5,x+3]+ 1*image[y+5,x+4]+ 1*image[y+5,x+5]+ 0*image[y+5,x+6]+ 0*image[y+5,x+7]+ 0*image[y+5,x+8]+\
 */
      __pyx_t_87 = (__pyx_v_y + 4);
      __pyx_t_88 = (__pyx_v_x + 1);
      __pyx_t_14 = -1;
      if (__pyx_t_87 < 0) {
        __pyx_t_87 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_87 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_87 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_88 < 0) {
        __pyx_t_88 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_88 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_88 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 24, __pyx_L1_error)
      }
 ...
 *                   0*image[y+6,x+0]+ 0*image[y+6,x+1]+ 0*image[y+4,x+2]+ 1*image[y+6,x+3]+ 1*image[y+6,x+4]+ 1*image[y+6,x+5]+ 0*image[y+6,x+6]+ 0*image[y+6,x+7]+ 0*image[y+6,x+8]+\
 */
      __pyx_t_89 = (__pyx_v_y + 4);
      __pyx_t_90 = (__pyx_v_x + 2);
      __pyx_t_14 = -1;
      if (__pyx_t_89 < 0) {
        __pyx_t_89 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_89 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_89 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_90 < 0) {
        __pyx_t_90 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_90 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_90 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 24, __pyx_L1_error)
      }
      __pyx_t_91 = (__pyx_v_y + 4);
      __pyx_t_92 = (__pyx_v_x + 3);
      __pyx_t_14 = -1;
      if (__pyx_t_91 < 0) {
        __pyx_t_91 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_91 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_91 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_92 < 0) {
        __pyx_t_92 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_92 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_92 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 24, __pyx_L1_error)
      }
      __pyx_t_93 = (__pyx_v_y + 4);
      __pyx_t_94 = (__pyx_v_x + 4);
      __pyx_t_14 = -1;
      if (__pyx_t_93 < 0) {
        __pyx_t_93 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_93 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_93 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_94 < 0) {
        __pyx_t_94 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_94 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_94 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 24, __pyx_L1_error)
      }
      __pyx_t_95 = (__pyx_v_y + 4);
      __pyx_t_96 = (__pyx_v_x + 5);
      __pyx_t_14 = -1;
      if (__pyx_t_95 < 0) {
        __pyx_t_95 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_95 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_95 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_96 < 0) {
        __pyx_t_96 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_96 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_96 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 24, __pyx_L1_error)
      }
      __pyx_t_97 = (__pyx_v_y + 4);
      __pyx_t_98 = (__pyx_v_x + 6);
      __pyx_t_14 = -1;
      if (__pyx_t_97 < 0) {
        __pyx_t_97 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_97 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_97 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_98 < 0) {
        __pyx_t_98 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_98 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_98 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 24, __pyx_L1_error)
      }
      __pyx_t_99 = (__pyx_v_y + 4);
      __pyx_t_100 = (__pyx_v_x + 7);
      __pyx_t_14 = -1;
      if (__pyx_t_99 < 0) {
        __pyx_t_99 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_99 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_99 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_100 < 0) {
        __pyx_t_100 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_100 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_100 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 24, __pyx_L1_error)
      }
      __pyx_t_101 = (__pyx_v_y + 4);
      __pyx_t_102 = (__pyx_v_x + 8);
      __pyx_t_14 = -1;
      if (__pyx_t_101 < 0) {
        __pyx_t_101 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_101 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_101 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_102 < 0) {
        __pyx_t_102 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_102 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_102 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 24, __pyx_L1_error)
      }
 ...
 *                   0*image[y+5,x+0]+ 0*image[y+5,x+1]+ 0*image[y+4,x+2]+ 1*image[y+5,x+3]+ 1*image[y+5,x+4]+ 1*image[y+5,x+5]+ 0*image[y+5,x+6]+ 0*image[y+5,x+7]+ 0*image[y+5,x+8]+\             # <<<<<<<<<<<<<<
 *                   0*image[y+6,x+0]+ 0*image[y+6,x+1]+ 0*image[y+4,x+2]+ 1*image[y+6,x+3]+ 1*image[y+6,x+4]+ 1*image[y+6,x+5]+ 0*image[y+6,x+6]+ 0*image[y+6,x+7]+ 0*image[y+6,x+8]+\
 *                   0*image[y+7,x+0]+ 0*image[y+7,x+1]+ 0*image[y+4,x+2]+ 0*image[y+7,x+3]+ 0*image[y+7,x+4]+ 0*image[y+7,x+5]+ 0*image[y+7,x+6]+ 0*image[y+7,x+7]+ 0*image[y+7,x+8]+\
 */
      __pyx_t_103 = (__pyx_v_y + 5);
      __pyx_t_104 = (__pyx_v_x + 0);
      __pyx_t_14 = -1;
      if (__pyx_t_103 < 0) {
        __pyx_t_103 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_103 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_103 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_104 < 0) {
        __pyx_t_104 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_104 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_104 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
 ...
 *                   0*image[y+6,x+0]+ 0*image[y+6,x+1]+ 0*image[y+4,x+2]+ 1*image[y+6,x+3]+ 1*image[y+6,x+4]+ 1*image[y+6,x+5]+ 0*image[y+6,x+6]+ 0*image[y+6,x+7]+ 0*image[y+6,x+8]+\
 */
      __pyx_t_105 = (__pyx_v_y + 5);
      __pyx_t_106 = (__pyx_v_x + 1);
      __pyx_t_14 = -1;
      if (__pyx_t_105 < 0) {
        __pyx_t_105 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_105 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_105 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_106 < 0) {
        __pyx_t_106 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_106 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_106 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
 ...
 *                   0*image[y+7,x+0]+ 0*image[y+7,x+1]+ 0*image[y+4,x+2]+ 0*image[y+7,x+3]+ 0*image[y+7,x+4]+ 0*image[y+7,x+5]+ 0*image[y+7,x+6]+ 0*image[y+7,x+7]+ 0*image[y+7,x+8]+\
 */
      __pyx_t_107 = (__pyx_v_y + 4);
      __pyx_t_108 = (__pyx_v_x + 2);
      __pyx_t_14 = -1;
      if (__pyx_t_107 < 0) {
        __pyx_t_107 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_107 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_107 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_108 < 0) {
        __pyx_t_108 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_108 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_108 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
      __pyx_t_109 = (__pyx_v_y + 5);
      __pyx_t_110 = (__pyx_v_x + 3);
      __pyx_t_14 = -1;
      if (__pyx_t_109 < 0) {
        __pyx_t_109 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_109 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_109 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_110 < 0) {
        __pyx_t_110 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_110 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_110 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
      __pyx_t_111 = (__pyx_v_y + 5);
      __pyx_t_112 = (__pyx_v_x + 4);
      __pyx_t_14 = -1;
      if (__pyx_t_111 < 0) {
        __pyx_t_111 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_111 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_111 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_112 < 0) {
        __pyx_t_112 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_112 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_112 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
      __pyx_t_113 = (__pyx_v_y + 5);
      __pyx_t_114 = (__pyx_v_x + 5);
      __pyx_t_14 = -1;
      if (__pyx_t_113 < 0) {
        __pyx_t_113 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_113 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_113 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_114 < 0) {
        __pyx_t_114 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_114 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_114 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
      __pyx_t_115 = (__pyx_v_y + 5);
      __pyx_t_116 = (__pyx_v_x + 6);
      __pyx_t_14 = -1;
      if (__pyx_t_115 < 0) {
        __pyx_t_115 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_115 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_115 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_116 < 0) {
        __pyx_t_116 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_116 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_116 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
      __pyx_t_117 = (__pyx_v_y + 5);
      __pyx_t_118 = (__pyx_v_x + 7);
      __pyx_t_14 = -1;
      if (__pyx_t_117 < 0) {
        __pyx_t_117 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_117 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_117 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_118 < 0) {
        __pyx_t_118 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_118 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_118 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
      __pyx_t_119 = (__pyx_v_y + 5);
      __pyx_t_120 = (__pyx_v_x + 8);
      __pyx_t_14 = -1;
      if (__pyx_t_119 < 0) {
        __pyx_t_119 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_119 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_119 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_120 < 0) {
        __pyx_t_120 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_120 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_120 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 25, __pyx_L1_error)
      }
 ...
 *                   0*image[y+6,x+0]+ 0*image[y+6,x+1]+ 0*image[y+4,x+2]+ 1*image[y+6,x+3]+ 1*image[y+6,x+4]+ 1*image[y+6,x+5]+ 0*image[y+6,x+6]+ 0*image[y+6,x+7]+ 0*image[y+6,x+8]+\             # <<<<<<<<<<<<<<
 *                   0*image[y+7,x+0]+ 0*image[y+7,x+1]+ 0*image[y+4,x+2]+ 0*image[y+7,x+3]+ 0*image[y+7,x+4]+ 0*image[y+7,x+5]+ 0*image[y+7,x+6]+ 0*image[y+7,x+7]+ 0*image[y+7,x+8]+\
 *                   1*image[y+8,x+0]+ 0*image[y+8,x+1]+ 0*image[y+4,x+2]+ 0*image[y+8,x+3]+ 0*image[y+8,x+4]+ 0*image[y+8,x+5]+ 0*image[y+8,x+6]+ 0*image[y+8,x+7]+ 1*image[y+8,x+8]
 */
      __pyx_t_121 = (__pyx_v_y + 6);
      __pyx_t_122 = (__pyx_v_x + 0);
      __pyx_t_14 = -1;
      if (__pyx_t_121 < 0) {
        __pyx_t_121 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_121 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_121 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_122 < 0) {
        __pyx_t_122 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_122 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_122 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
 ...
 *                   0*image[y+7,x+0]+ 0*image[y+7,x+1]+ 0*image[y+4,x+2]+ 0*image[y+7,x+3]+ 0*image[y+7,x+4]+ 0*image[y+7,x+5]+ 0*image[y+7,x+6]+ 0*image[y+7,x+7]+ 0*image[y+7,x+8]+\
 */
      __pyx_t_123 = (__pyx_v_y + 6);
      __pyx_t_124 = (__pyx_v_x + 1);
      __pyx_t_14 = -1;
      if (__pyx_t_123 < 0) {
        __pyx_t_123 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_123 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_123 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_124 < 0) {
        __pyx_t_124 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_124 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_124 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 26, __pyx_L1_error)
      }
 ...
 *                   1*image[y+8,x+0]+ 0*image[y+8,x+1]+ 0*image[y+4,x+2]+ 0*image[y+8,x+3]+ 0*image[y+8,x+4]+ 0*image[y+8,x+5]+ 0*image[y+8,x+6]+ 0*image[y+8,x+7]+ 1*image[y+8,x+8]
 */
      __pyx_t_125 = (__pyx_v_y + 4);
      __pyx_t_126 = (__pyx_v_x + 2);
      __pyx_t_14 = -1;
      if (__pyx_t_125 < 0) {
        __pyx_t_125 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_125 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_125 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_126 < 0) {
        __pyx_t_126 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_126 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_126 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 26, __pyx_L1_error)
      }
      __pyx_t_127 = (__pyx_v_y + 6);
      __pyx_t_128 = (__pyx_v_x + 3);
      __pyx_t_14 = -1;
      if (__pyx_t_127 < 0) {
        __pyx_t_127 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_127 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_127 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_128 < 0) {
        __pyx_t_128 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_128 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_128 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 26, __pyx_L1_error)
      }
      __pyx_t_129 = (__pyx_v_y + 6);
      __pyx_t_130 = (__pyx_v_x + 4);
      __pyx_t_14 = -1;
      if (__pyx_t_129 < 0) {
        __pyx_t_129 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_129 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_129 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_130 < 0) {
        __pyx_t_130 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_130 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_130 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 26, __pyx_L1_error)
      }
      __pyx_t_131 = (__pyx_v_y + 6);
      __pyx_t_132 = (__pyx_v_x + 5);
      __pyx_t_14 = -1;
      if (__pyx_t_131 < 0) {
        __pyx_t_131 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_131 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_131 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_132 < 0) {
        __pyx_t_132 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_132 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_132 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 26, __pyx_L1_error)
      }
      __pyx_t_133 = (__pyx_v_y + 6);
      __pyx_t_134 = (__pyx_v_x + 6);
      __pyx_t_14 = -1;
      if (__pyx_t_133 < 0) {
        __pyx_t_133 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_133 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_133 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_134 < 0) {
        __pyx_t_134 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_134 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_134 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 26, __pyx_L1_error)
      }
      __pyx_t_135 = (__pyx_v_y + 6);
      __pyx_t_136 = (__pyx_v_x + 7);
      __pyx_t_14 = -1;
      if (__pyx_t_135 < 0) {
        __pyx_t_135 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_135 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_135 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_136 < 0) {
        __pyx_t_136 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_136 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_136 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 26, __pyx_L1_error)
      }
      __pyx_t_137 = (__pyx_v_y + 6);
      __pyx_t_138 = (__pyx_v_x + 8);
      __pyx_t_14 = -1;
      if (__pyx_t_137 < 0) {
        __pyx_t_137 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_137 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_137 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_138 < 0) {
        __pyx_t_138 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_138 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_138 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 26, __pyx_L1_error)
      }
 ...
 * 
 */
      __pyx_t_139 = (__pyx_v_y + 7);
      __pyx_t_140 = (__pyx_v_x + 0);
      __pyx_t_14 = -1;
      if (__pyx_t_139 < 0) {
        __pyx_t_139 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_139 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_139 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_140 < 0) {
        __pyx_t_140 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_140 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_140 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
 ...
 *                   1*image[y+8,x+0]+ 0*image[y+8,x+1]+ 0*image[y+4,x+2]+ 0*image[y+8,x+3]+ 0*image[y+8,x+4]+ 0*image[y+8,x+5]+ 0*image[y+8,x+6]+ 0*image[y+8,x+7]+ 1*image[y+8,x+8]
 */
      __pyx_t_141 = (__pyx_v_y + 7);
      __pyx_t_142 = (__pyx_v_x + 1);
      __pyx_t_14 = -1;
      if (__pyx_t_141 < 0) {
        __pyx_t_141 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_141 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_141 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_142 < 0) {
        __pyx_t_142 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_142 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_142 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
 ...
 * 
 */
      __pyx_t_143 = (__pyx_v_y + 4);
      __pyx_t_144 = (__pyx_v_x + 2);
      __pyx_t_14 = -1;
      if (__pyx_t_143 < 0) {
        __pyx_t_143 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_143 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_143 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_144 < 0) {
        __pyx_t_144 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_144 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_144 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      __pyx_t_145 = (__pyx_v_y + 7);
      __pyx_t_146 = (__pyx_v_x + 3);
      __pyx_t_14 = -1;
      if (__pyx_t_145 < 0) {
        __pyx_t_145 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_145 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_145 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_146 < 0) {
        __pyx_t_146 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_146 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_146 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      __pyx_t_147 = (__pyx_v_y + 7);
      __pyx_t_148 = (__pyx_v_x + 4);
      __pyx_t_14 = -1;
      if (__pyx_t_147 < 0) {
        __pyx_t_147 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_147 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_147 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_148 < 0) {
        __pyx_t_148 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_148 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_148 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      __pyx_t_149 = (__pyx_v_y + 7);
      __pyx_t_150 = (__pyx_v_x + 5);
      __pyx_t_14 = -1;
      if (__pyx_t_149 < 0) {
        __pyx_t_149 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_149 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_149 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_150 < 0) {
        __pyx_t_150 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_150 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_150 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      __pyx_t_151 = (__pyx_v_y + 7);
      __pyx_t_152 = (__pyx_v_x + 6);
      __pyx_t_14 = -1;
      if (__pyx_t_151 < 0) {
        __pyx_t_151 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_151 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_151 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_152 < 0) {
        __pyx_t_152 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_152 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_152 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      __pyx_t_153 = (__pyx_v_y + 7);
      __pyx_t_154 = (__pyx_v_x + 7);
      __pyx_t_14 = -1;
      if (__pyx_t_153 < 0) {
        __pyx_t_153 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_153 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_153 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_154 < 0) {
        __pyx_t_154 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_154 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_154 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
      __pyx_t_155 = (__pyx_v_y + 7);
      __pyx_t_156 = (__pyx_v_x + 8);
      __pyx_t_14 = -1;
      if (__pyx_t_155 < 0) {
        __pyx_t_155 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_155 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_155 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_156 < 0) {
        __pyx_t_156 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_156 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_156 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 27, __pyx_L1_error)
      }
 ...
 *                   1*image[y+8,x+0]+ 0*image[y+8,x+1]+ 0*image[y+4,x+2]+ 0*image[y+8,x+3]+ 0*image[y+8,x+4]+ 0*image[y+8,x+5]+ 0*image[y+8,x+6]+ 0*image[y+8,x+7]+ 1*image[y+8,x+8]             # <<<<<<<<<<<<<<
 * 
 *             output[y+1,x+1] = GX//val
 */
      __pyx_t_157 = (__pyx_v_y + 8);
      __pyx_t_158 = (__pyx_v_x + 0);
      __pyx_t_14 = -1;
      if (__pyx_t_157 < 0) {
        __pyx_t_157 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_157 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_157 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_158 < 0) {
        __pyx_t_158 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_158 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_158 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
 ...
 * 
 */
      __pyx_t_159 = (__pyx_v_y + 8);
      __pyx_t_160 = (__pyx_v_x + 1);
      __pyx_t_14 = -1;
      if (__pyx_t_159 < 0) {
        __pyx_t_159 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_159 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_159 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_160 < 0) {
        __pyx_t_160 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_160 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_160 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
 ...
 *             output[y+1,x+1] = GX//val
 */
      __pyx_t_161 = (__pyx_v_y + 4);
      __pyx_t_162 = (__pyx_v_x + 2);
      __pyx_t_14 = -1;
      if (__pyx_t_161 < 0) {
        __pyx_t_161 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_161 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_161 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_162 < 0) {
        __pyx_t_162 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_162 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_162 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
      __pyx_t_163 = (__pyx_v_y + 8);
      __pyx_t_164 = (__pyx_v_x + 3);
      __pyx_t_14 = -1;
      if (__pyx_t_163 < 0) {
        __pyx_t_163 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_163 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_163 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_164 < 0) {
        __pyx_t_164 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_164 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_164 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
      __pyx_t_165 = (__pyx_v_y + 8);
      __pyx_t_166 = (__pyx_v_x + 4);
      __pyx_t_14 = -1;
      if (__pyx_t_165 < 0) {
        __pyx_t_165 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_165 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_165 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_166 < 0) {
        __pyx_t_166 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_166 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_166 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
      __pyx_t_167 = (__pyx_v_y + 8);
      __pyx_t_168 = (__pyx_v_x + 5);
      __pyx_t_14 = -1;
      if (__pyx_t_167 < 0) {
        __pyx_t_167 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_167 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_167 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_168 < 0) {
        __pyx_t_168 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_168 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_168 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
      __pyx_t_169 = (__pyx_v_y + 8);
      __pyx_t_170 = (__pyx_v_x + 6);
      __pyx_t_14 = -1;
      if (__pyx_t_169 < 0) {
        __pyx_t_169 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_169 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_169 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_170 < 0) {
        __pyx_t_170 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_170 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_170 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
      __pyx_t_171 = (__pyx_v_y + 8);
      __pyx_t_172 = (__pyx_v_x + 7);
      __pyx_t_14 = -1;
      if (__pyx_t_171 < 0) {
        __pyx_t_171 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_171 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_171 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_172 < 0) {
        __pyx_t_172 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_172 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_172 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
      __pyx_t_173 = (__pyx_v_y + 8);
      __pyx_t_174 = (__pyx_v_x + 8);
      __pyx_t_14 = -1;
      if (__pyx_t_173 < 0) {
        __pyx_t_173 += __pyx_v_image.shape[0];
        if (unlikely(__pyx_t_173 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_173 >= __pyx_v_image.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_174 < 0) {
        __pyx_t_174 += __pyx_v_image.shape[1];
        if (unlikely(__pyx_t_174 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_174 >= __pyx_v_image.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 28, __pyx_L1_error)
      }
      __pyx_v_GX = (((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((((1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_12 * __pyx_v_image.strides[0]) ) + __pyx_t_13 * __pyx_v_image.strides[1]) )))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_15 * __pyx_v_image.strides[0]) ) + __pyx_t_16 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_17 * __pyx_v_image.strides[0]) ) + __pyx_t_18 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_19 * __pyx_v_image.strides[0]) ) + __pyx_t_20 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_21 * __pyx_v_image.strides[0]) ) + __pyx_t_22 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_23 * __pyx_v_image.strides[0]) ) + __pyx_t_24 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_25 * __pyx_v_image.strides[0]) ) + __pyx_t_26 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_27 * __pyx_v_image.strides[0]) ) + __pyx_t_28 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_29 * __pyx_v_image.strides[0]) ) + __pyx_t_30 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_31 * __pyx_v_image.strides[0]) ) + __pyx_t_32 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_33 * __pyx_v_image.strides[0]) ) + __pyx_t_34 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_35 * __pyx_v_image.strides[0]) ) + __pyx_t_36 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_37 * __pyx_v_image.strides[0]) ) + __pyx_t_38 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_39 * __pyx_v_image.strides[0]) ) + __pyx_t_40 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_41 * __pyx_v_image.strides[0]) ) + __pyx_t_42 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_43 * __pyx_v_image.strides[0]) ) + __pyx_t_44 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_45 * __pyx_v_image.strides[0]) ) + __pyx_t_46 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_47 * __pyx_v_image.strides[0]) ) + __pyx_t_48 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_49 * __pyx_v_image.strides[0]) ) + __pyx_t_50 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_51 * __pyx_v_image.strides[0]) ) + __pyx_t_52 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_53 * __pyx_v_image.strides[0]) ) + __pyx_t_54 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_55 * __pyx_v_image.strides[0]) ) + __pyx_t_56 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_57 * __pyx_v_image.strides[0]) ) + __pyx_t_58 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_59 * __pyx_v_image.strides[0]) ) + __pyx_t_60 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_61 * __pyx_v_image.strides[0]) ) + __pyx_t_62 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_63 * __pyx_v_image.strides[0]) ) + __pyx_t_64 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_65 * __pyx_v_image.strides[0]) ) + __pyx_t_66 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_67 * __pyx_v_image.strides[0]) ) + __pyx_t_68 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_69 * __pyx_v_image.strides[0]) ) + __pyx_t_70 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_71 * __pyx_v_image.strides[0]) ) + __pyx_t_72 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_73 * __pyx_v_image.strides[0]) ) + __pyx_t_74 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_75 * __pyx_v_image.strides[0]) ) + __pyx_t_76 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_77 * __pyx_v_image.strides[0]) ) + __pyx_t_78 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_79 * __pyx_v_image.strides[0]) ) + __pyx_t_80 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_81 * __pyx_v_image.strides[0]) ) + __pyx_t_82 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_83 * __pyx_v_image.strides[0]) ) + __pyx_t_84 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_85 * __pyx_v_image.strides[0]) ) + __pyx_t_86 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_87 * __pyx_v_image.strides[0]) ) + __pyx_t_88 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_89 * __pyx_v_image.strides[0]) ) + __pyx_t_90 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_91 * __pyx_v_image.strides[0]) ) + __pyx_t_92 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_93 * __pyx_v_image.strides[0]) ) + __pyx_t_94 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_95 * __pyx_v_image.strides[0]) ) + __pyx_t_96 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_97 * __pyx_v_image.strides[0]) ) + __pyx_t_98 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_99 * __pyx_v_image.strides[0]) ) + __pyx_t_100 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_101 * __pyx_v_image.strides[0]) ) + __pyx_t_102 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_103 * __pyx_v_image.strides[0]) ) + __pyx_t_104 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_105 * __pyx_v_image.strides[0]) ) + __pyx_t_106 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_107 * __pyx_v_image.strides[0]) ) + __pyx_t_108 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_109 * __pyx_v_image.strides[0]) ) + __pyx_t_110 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_111 * __pyx_v_image.strides[0]) ) + __pyx_t_112 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_113 * __pyx_v_image.strides[0]) ) + __pyx_t_114 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_115 * __pyx_v_image.strides[0]) ) + __pyx_t_116 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_117 * __pyx_v_image.strides[0]) ) + __pyx_t_118 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_119 * __pyx_v_image.strides[0]) ) + __pyx_t_120 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_121 * __pyx_v_image.strides[0]) ) + __pyx_t_122 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_123 * __pyx_v_image.strides[0]) ) + __pyx_t_124 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_125 * __pyx_v_image.strides[0]) ) + __pyx_t_126 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_127 * __pyx_v_image.strides[0]) ) + __pyx_t_128 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_129 * __pyx_v_image.strides[0]) ) + __pyx_t_130 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_131 * __pyx_v_image.strides[0]) ) + __pyx_t_132 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_133 * __pyx_v_image.strides[0]) ) + __pyx_t_134 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_135 * __pyx_v_image.strides[0]) ) + __pyx_t_136 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_137 * __pyx_v_image.strides[0]) ) + __pyx_t_138 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_139 * __pyx_v_image.strides[0]) ) + __pyx_t_140 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_141 * __pyx_v_image.strides[0]) ) + __pyx_t_142 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_143 * __pyx_v_image.strides[0]) ) + __pyx_t_144 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_145 * __pyx_v_image.strides[0]) ) + __pyx_t_146 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_147 * __pyx_v_image.strides[0]) ) + __pyx_t_148 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_149 * __pyx_v_image.strides[0]) ) + __pyx_t_150 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_151 * __pyx_v_image.strides[0]) ) + __pyx_t_152 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_153 * __pyx_v_image.strides[0]) ) + __pyx_t_154 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_155 * __pyx_v_image.strides[0]) ) + __pyx_t_156 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_157 * __pyx_v_image.strides[0]) ) + __pyx_t_158 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_159 * __pyx_v_image.strides[0]) ) + __pyx_t_160 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_161 * __pyx_v_image.strides[0]) ) + __pyx_t_162 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_163 * __pyx_v_image.strides[0]) ) + __pyx_t_164 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_165 * __pyx_v_image.strides[0]) ) + __pyx_t_166 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_167 * __pyx_v_image.strides[0]) ) + __pyx_t_168 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_169 * __pyx_v_image.strides[0]) ) + __pyx_t_170 * __pyx_v_image.strides[1]) ))))) + (0 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_171 * __pyx_v_image.strides[0]) ) + __pyx_t_172 * __pyx_v_image.strides[1]) ))))) + (1 * (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_173 * __pyx_v_image.strides[0]) ) + __pyx_t_174 * __pyx_v_image.strides[1]) )))));

      /* "gaussian.pyx":30
 *                   1*image[y+8,x+0]+ 0*image[y+8,x+1]+ 0*image[y+4,x+2]+ 0*image[y+8,x+3]+ 0*image[y+8,x+4]+ 0*image[y+8,x+5]+ 0*image[y+8,x+6]+ 0*image[y+8,x+7]+ 1*image[y+8,x+8]
 * 
 *             output[y+1,x+1] = GX//val             # <<<<<<<<<<<<<<
 *     output = output.astype(np.ubyte)
 *     return output
 */
      ...
      else if (sizeof(int) == sizeof(long) && (!(((int)-1) > 0)) && unlikely(__pyx_v_val == (int)-1)  && unlikely(UNARY_NEG_WOULD_OVERFLOW(__pyx_v_GX))) {
        PyErr_SetString(PyExc_OverflowError, "value too large to perform division");
        __PYX_ERR(0, 30, __pyx_L1_error)
      }
      __pyx_t_5 = __Pyx_PyInt_From_int(__Pyx_div_int(__pyx_v_GX, __pyx_v_val)); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 30, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_y + 1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 30, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_3 = __Pyx_PyInt_From_long((__pyx_v_x + 1)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 30, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
 ...
 *     return output
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_output, __pyx_n_s_astype); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_ubyte); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
 ...
 *     return output             # <<<<<<<<<<<<<<
 */
  __pyx_t_175 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(__pyx_v_output, PyBUF_WRITABLE); if (unlikely(!__pyx_t_175.memview)) __PYX_ERR(0, 32, __pyx_L1_error)
  __pyx_r = __pyx_t_175;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_175, 1);
  __pyx_r.data = NULL;
  __pyx_r.memview = NULL;
  __Pyx_AddTraceback("gaussian.gaussian_blur", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_8gaussian_1gaussian_blur(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8gaussian_1gaussian_blur(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_image,&__pyx_n_s_val,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_val)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("gaussian_blur", 1, 2, 2, 1); __PYX_ERR(0, 10, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "gaussian_blur") < 0)) __PYX_ERR(0, 10, __pyx_L3_error)
      }
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 10, __pyx_L3_error)
    __pyx_v_val = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_val == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("gaussian_blur", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 10, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("gaussian.gaussian_blur", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_8gaussian_gaussian_blur(__pyx_self, __pyx_v_image, __pyx_v_val);
...
static PyObject *__pyx_pf_8gaussian_gaussian_blur(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, int __pyx_v_val) {
  ...
  __pyx_t_1 = __pyx_f_8gaussian_gaussian_blur(__pyx_v_image, __pyx_v_val, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 10, __pyx_L1_error)
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyArray_MultiIterNew5(PyObject *__pyx_v_a, PyObject *__pyx_v_b, PyObject *__pyx_v_c, PyObject *__pyx_v_d, PyObject *__pyx_v_e) {
  ...
  /* "../env/lib/site-packages/numpy/__init__.pxd":755
 * 
 * cdef inline object PyArray_MultiIterNew5(a, b, c, d, e):
 *     return PyArray_MultiIterNew(5, <void*>a, <void*>b, <void*>c, <void*> d, <void*> e)             # <<<<<<<<<<<<<<
 * 
...
/* "../env/lib/site-packages/numpy/__init__.pxd":757
 *     return PyArray_MultiIterNew(5, <void*>a, <void*>b, <void*>c, <void*> d, <void*> e)
 * 
 * cdef inline tuple PyDataType_SHAPE(dtype d):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE PyObject *__pyx_f_5numpy_PyDataType_SHAPE(PyArray_Descr *__pyx_v_d) {
  ...
  /* "../env/lib/site-packages/numpy/__init__.pxd":758
 * 
 * cdef inline tuple PyDataType_SHAPE(dtype d):
 *     if PyDataType_HASSUBARRAY(d):             # <<<<<<<<<<<<<<
 *         return <tuple>d.subarray.shape
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":759
 * cdef inline tuple PyDataType_SHAPE(dtype d):
 *     if PyDataType_HASSUBARRAY(d):
 *         return <tuple>d.subarray.shape             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "../env/lib/site-packages/numpy/__init__.pxd":761
 *         return <tuple>d.subarray.shape
 *     else:
 *         return ()             # <<<<<<<<<<<<<<
 * 
...
/* "../env/lib/site-packages/numpy/__init__.pxd":763
 *         return ()
 * 
 * cdef inline char* _util_dtypestring(dtype descr, char* f, char* end, int* offset) except NULL:             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE char *__pyx_f_5numpy__util_dtypestring(PyArray_Descr *__pyx_v_descr, char *__pyx_v_f, char *__pyx_v_end, int *__pyx_v_offset) {
  ...
  /* "../env/lib/site-packages/numpy/__init__.pxd":768
 * 
 *     cdef dtype child
 ...
 */
  ...
  /* "../env/lib/site-packages/numpy/__init__.pxd":769
 *     cdef dtype child
 *     cdef int endian_detector = 1
 *     cdef bint little_endian = ((<char*>&endian_detector)[0] != 0)             # <<<<<<<<<<<<<<
 *     cdef tuple fields
 ...
 */
  ...
  /* "../env/lib/site-packages/numpy/__init__.pxd":772
 *     cdef tuple fields
 * 
 ...
 */
  ...
  for (;;) {
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":773
 * 
 *     for childname in descr.names:
 *         fields = descr.fields[childname]             # <<<<<<<<<<<<<<
 *         child, new_offset = fields
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":774
 *     for childname in descr.names:
 *         fields = descr.fields[childname]
 *         child, new_offset = fields             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":776
 *         child, new_offset = fields
 * 
 *         if (end - f) - <int>(new_offset - offset[0]) < 15:             # <<<<<<<<<<<<<<
 ...
 */
    ...
    if (unlikely(__pyx_t_6)) {
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":777
 * 
 *         if (end - f) - <int>(new_offset - offset[0]) < 15:
 *             raise RuntimeError(u"Format string allocated too short, see comment in numpy.pxd")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":779
 *             raise RuntimeError(u"Format string allocated too short, see comment in numpy.pxd")
 * 
 *         if ((child.byteorder == c'>' and little_endian) or             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":780
 * 
 *         if ((child.byteorder == c'>' and little_endian) or
 *             (child.byteorder == c'<' and not little_endian)):             # <<<<<<<<<<<<<<
 *             raise ValueError(u"Non-native byte order not supported")
 ...
 */
    if (unlikely(__pyx_t_6)) {
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":781
 *         if ((child.byteorder == c'>' and little_endian) or
 *             (child.byteorder == c'<' and not little_endian)):
 *             raise ValueError(u"Non-native byte order not supported")             # <<<<<<<<<<<<<<
 *             # One could encode it in the format string and have Cython
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":791
 * 
 ...
 */
    while (1) {
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":792
 *         # Output padding bytes
 *         while offset[0] < new_offset:
 *             f[0] = 120 # "x"; pad byte             # <<<<<<<<<<<<<<
 *             f += 1
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":793
 *         while offset[0] < new_offset:
 *             f[0] = 120 # "x"; pad byte
 *             f += 1             # <<<<<<<<<<<<<<
 *             offset[0] += 1
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":794
 *             f[0] = 120 # "x"; pad byte
 *             f += 1
 *             offset[0] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":796
 *             offset[0] += 1
 * 
 *         offset[0] += child.itemsize             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":798
 *         offset[0] += child.itemsize
 * 
 *         if not PyDataType_HASFIELDS(child):             # <<<<<<<<<<<<<<
 *             t = child.type_num
 ...
 */
    ...
    if (__pyx_t_6) {
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":799
 * 
 *         if not PyDataType_HASFIELDS(child):
 *             t = child.type_num             # <<<<<<<<<<<<<<
 *             if end - f < 5:
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":800
 *         if not PyDataType_HASFIELDS(child):
 *             t = child.type_num
 *             if end - f < 5:             # <<<<<<<<<<<<<<
 *                 raise RuntimeError(u"Format string allocated too short.")
 ...
 */
      ...
      if (unlikely(__pyx_t_6)) {
        ...
        /* "../env/lib/site-packages/numpy/__init__.pxd":801
 *             t = child.type_num
 *             if end - f < 5:
 *                 raise RuntimeError(u"Format string allocated too short.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":804
 * 
 *             # Until ticket #99 is fixed, use integers to avoid warnings
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":805
 *             # Until ticket #99 is fixed, use integers to avoid warnings
 *             if   t == NPY_BYTE:        f[0] =  98 #"b"
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"             # <<<<<<<<<<<<<<
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":806
 *             if   t == NPY_BYTE:        f[0] =  98 #"b"
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"             # <<<<<<<<<<<<<<
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":807
 *             elif t == NPY_UBYTE:       f[0] =  66 #"B"
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"             # <<<<<<<<<<<<<<
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":808
 *             elif t == NPY_SHORT:       f[0] = 104 #"h"
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 *             elif t == NPY_INT:         f[0] = 105 #"i"             # <<<<<<<<<<<<<<
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":809
 *             elif t == NPY_USHORT:      f[0] =  72 #"H"
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 *             elif t == NPY_UINT:        f[0] =  73 #"I"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":810
 *             elif t == NPY_INT:         f[0] = 105 #"i"
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 *             elif t == NPY_LONG:        f[0] = 108 #"l"             # <<<<<<<<<<<<<<
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":811
 *             elif t == NPY_UINT:        f[0] =  73 #"I"
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":812
 *             elif t == NPY_LONG:        f[0] = 108 #"l"
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"             # <<<<<<<<<<<<<<
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":813
 *             elif t == NPY_ULONG:       f[0] = 76  #"L"
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"             # <<<<<<<<<<<<<<
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":814
 *             elif t == NPY_LONGLONG:    f[0] = 113 #"q"
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"             # <<<<<<<<<<<<<<
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":815
 *             elif t == NPY_ULONGLONG:   f[0] = 81  #"Q"
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"             # <<<<<<<<<<<<<<
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":816
 *             elif t == NPY_FLOAT:       f[0] = 102 #"f"
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"             # <<<<<<<<<<<<<<
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":817
 *             elif t == NPY_DOUBLE:      f[0] = 100 #"d"
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf             # <<<<<<<<<<<<<<
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":818
 *             elif t == NPY_LONGDOUBLE:  f[0] = 103 #"g"
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd             # <<<<<<<<<<<<<<
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":819
 *             elif t == NPY_CFLOAT:      f[0] = 90; f[1] = 102; f += 1 # Zf
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg             # <<<<<<<<<<<<<<
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":820
 *             elif t == NPY_CDOUBLE:     f[0] = 90; f[1] = 100; f += 1 # Zd
 *             elif t == NPY_CLONGDOUBLE: f[0] = 90; f[1] = 103; f += 1 # Zg
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"             # <<<<<<<<<<<<<<
 *             else:
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":822
 *             elif t == NPY_OBJECT:      f[0] = 79 #"O"
 *             else:
 *                 raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)             # <<<<<<<<<<<<<<
 *             f += 1
 ...
 */
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":823
 *             else:
 *                 raise ValueError(u"unknown dtype code in numpy.pxd (%d)" % t)
 *             f += 1             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":827
 *             # Cython ignores struct boundary information ("T{...}"),
 *             # so don't output it
 ...
 */
  ...
  /* "../env/lib/site-packages/numpy/__init__.pxd":828
 *             # so don't output it
 *             f = _util_dtypestring(child, f, end, offset)
 *     return f             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":958
 *     try:
 *         __pyx_import_array()
 *     except Exception:             # <<<<<<<<<<<<<<
 *         raise ImportError("numpy.core.multiarray failed to import")
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":959
 *         __pyx_import_array()
 *     except Exception:
 *         raise ImportError("numpy.core.multiarray failed to import")             # <<<<<<<<<<<<<<
 * 
...
/* "../env/lib/site-packages/numpy/__init__.pxd":961
 *         raise ImportError("numpy.core.multiarray failed to import")
 * 
 * cdef inline int import_umath() except -1:             # <<<<<<<<<<<<<<
 *     try:
...
static CYTHON_INLINE int __pyx_f_5numpy_import_umath(void) {
  ...
  /* "../env/lib/site-packages/numpy/__init__.pxd":962
 * 
 * cdef inline int import_umath() except -1:
 *     try:             # <<<<<<<<<<<<<<
 *         _import_umath()
 ...
 */
  {
    ...
    /*try:*/ {
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":963
 * cdef inline int import_umath() except -1:
 *     try:
 *         _import_umath()             # <<<<<<<<<<<<<<
 *     except Exception:
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":964
 *     try:
 *         _import_umath()
 *     except Exception:             # <<<<<<<<<<<<<<
 *         raise ImportError("numpy.core.umath failed to import")
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":965
 *         _import_umath()
 *     except Exception:
 *         raise ImportError("numpy.core.umath failed to import")             # <<<<<<<<<<<<<<
 * 
...
static CYTHON_INLINE int __pyx_f_5numpy_import_ufunc(void) {
  ...
  /* "../env/lib/site-packages/numpy/__init__.pxd":968
 * 
 * cdef inline int import_ufunc() except -1:
 *     try:             # <<<<<<<<<<<<<<
 *         _import_umath()
 ...
 */
  {
    ...
    /*try:*/ {
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":969
 * cdef inline int import_ufunc() except -1:
 *     try:
 *         _import_umath()             # <<<<<<<<<<<<<<
 *     except Exception:
 ...
 */
    ...
    /* "../env/lib/site-packages/numpy/__init__.pxd":970
 *     try:
 *         _import_umath()
 *     except Exception:             # <<<<<<<<<<<<<<
 *         raise ImportError("numpy.core.umath failed to import")
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "../env/lib/site-packages/numpy/__init__.pxd":971
 *         _import_umath()
 *     except Exception:
 *         raise ImportError("numpy.core.umath failed to import")             # <<<<<<<<<<<<<<
 * 
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "gaussian._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"gaussian_blur", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_8gaussian_1gaussian_blur, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_gaussian) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "gaussian")) {
      if (unlikely(PyDict_SetItemString(modules, "gaussian", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init gaussian", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init gaussian");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
