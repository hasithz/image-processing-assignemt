...
#define __PYX_HAVE__suppression
#define __PYX_HAVE_API__suppression
/* Early includes */
#include <string.h>
#include <stdio.h>
 ...
 * 
 * cpdef unsigned char [:, :] non_max_suppression(unsigned char [:, :] gradient_magnitude, unsigned char [:, :] gradient_direction):
 */
typedef __pyx_t_5numpy_uint_t __pyx_t_11suppression_DTYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'suppression' */
...
static __Pyx_memviewslice __pyx_f_11suppression_non_max_suppression(__Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "suppression"
extern int __pyx_module_is_main_suppression;
int __pyx_module_is_main_suppression = 0;
...
static const char __pyx_k_gradient_direction[] = "gradient_direction";
static const char __pyx_k_gradient_magnitude[] = "gradient_magnitude";
...
static PyObject *__pyx_n_s_gradient_direction;
...
static PyObject *__pyx_pf_11suppression_non_max_suppression(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_gradient_magnitude, __Pyx_memviewslice __pyx_v_gradient_direction); /* proto */
 ...
 * cpdef unsigned char [:, :] non_max_suppression(unsigned char [:, :] gradient_magnitude, unsigned char [:, :] gradient_direction):             # <<<<<<<<<<<<<<
 * 
 *     cdef int image_row, image_col, PI, row, col, direction, before_pixel, after_pixel
 */

static PyObject *__pyx_pw_11suppression_1non_max_suppression(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_11suppression_non_max_suppression(__Pyx_memviewslice __pyx_v_gradient_magnitude, __Pyx_memviewslice __pyx_v_gradient_direction, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  int __pyx_v_before_pixel;
  int __pyx_v_after_pixel;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("non_max_suppression", 0);

  /* "suppression.pyx":13
 *     cdef int image_row, image_col, PI, row, col, direction, before_pixel, after_pixel
 * 
 *     image_row = gradient_magnitude.shape[0]             # <<<<<<<<<<<<<<
 *     image_col = gradient_magnitude.shape[1]
 * 
 */
  __pyx_v_image_row = (__pyx_v_gradient_magnitude.shape[0]);
 ...
 * 
 */
  __pyx_v_image_col = (__pyx_v_gradient_magnitude.shape[1]);

  /* "suppression.pyx":17
 * 
 * 
 *     output = np.empty((image_row, image_col), dtype=np.ubyte)             # <<<<<<<<<<<<<<
 *     PI = 180
 * 
 */
 ...
 */
      ...
      __pyx_t_14 = -1;
      if (__pyx_t_12 < 0) {
        __pyx_t_12 += __pyx_v_gradient_direction.shape[0];
        if (unlikely(__pyx_t_12 < 0)) __pyx_t_14 = 0;
      } else if (unlikely(__pyx_t_12 >= __pyx_v_gradient_direction.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_v_gradient_direction.shape[1];
        if (unlikely(__pyx_t_13 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_13 >= __pyx_v_gradient_direction.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 22, __pyx_L1_error)
      }
      __pyx_v_direction = (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_gradient_direction.data + __pyx_t_12 * __pyx_v_gradient_direction.strides[0]) ) + __pyx_t_13 * __pyx_v_gradient_direction.strides[1]) )));
 ...
 */
      __pyx_t_16 = (0 <= __pyx_v_direction);
      if (__pyx_t_16) {
        __pyx_t_16 = (__pyx_v_direction < __Pyx_div_long(__pyx_v_PI, 8));
      }
      ...
      __pyx_t_17 = (__Pyx_div_long((15 * __pyx_v_PI), 8) <= __pyx_v_direction);
      if (__pyx_t_17) {
        __pyx_t_17 = (__pyx_v_direction <= (2 * __pyx_v_PI));
      }
 ...
 */
        ...
        __pyx_t_14 = -1;
        if (__pyx_t_13 < 0) {
          __pyx_t_13 += __pyx_v_gradient_magnitude.shape[0];
          if (unlikely(__pyx_t_13 < 0)) __pyx_t_14 = 0;
        } else if (unlikely(__pyx_t_13 >= __pyx_v_gradient_magnitude.shape[0])) __pyx_t_14 = 0;
        if (__pyx_t_12 < 0) {
          __pyx_t_12 += __pyx_v_gradient_magnitude.shape[1];
          if (unlikely(__pyx_t_12 < 0)) __pyx_t_14 = 1;
        } else if (unlikely(__pyx_t_12 >= __pyx_v_gradient_magnitude.shape[1])) __pyx_t_14 = 1;
        if (unlikely(__pyx_t_14 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_14);
          __PYX_ERR(0, 26, __pyx_L1_error)
        }
        __pyx_v_before_pixel = (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_gradient_magnitude.data + __pyx_t_13 * __pyx_v_gradient_magnitude.strides[0]) ) + __pyx_t_12 * __pyx_v_gradient_magnitude.strides[1]) )));
 ...
 */
        __pyx_t_12 = __pyx_v_row;
        __pyx_t_13 = (__pyx_v_col + 1);
        __pyx_t_14 = -1;
        if (__pyx_t_12 < 0) {
          __pyx_t_12 += __pyx_v_gradient_magnitude.shape[0];
          if (unlikely(__pyx_t_12 < 0)) __pyx_t_14 = 0;
        } else if (unlikely(__pyx_t_12 >= __pyx_v_gradient_magnitude.shape[0])) __pyx_t_14 = 0;
        if (__pyx_t_13 < 0) {
          __pyx_t_13 += __pyx_v_gradient_magnitude.shape[1];
          if (unlikely(__pyx_t_13 < 0)) __pyx_t_14 = 1;
        } else if (unlikely(__pyx_t_13 >= __pyx_v_gradient_magnitude.shape[1])) __pyx_t_14 = 1;
        if (unlikely(__pyx_t_14 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_14);
          __PYX_ERR(0, 27, __pyx_L1_error)
        }
        __pyx_v_after_pixel = (*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_gradient_magnitude.data + __pyx_t_12 * __pyx_v_gradient_magnitude.strides[0]) ) + __pyx_t_13 * __pyx_v_gradient_magnitude.strides[1]) )));
 ...
 */
      __pyx_t_16 = (__Pyx_div_long(__pyx_v_PI, 8) <= __pyx_v_direction);
      if (__pyx_t_16) {
        __pyx_t_16 = (__pyx_v_direction < __Pyx_div_long((3 * __pyx_v_PI), 8));
      }
      __pyx_t_17 = (__pyx_t_16 != 0);
      if (!__pyx_t_17) {
      } else {
      ...
      __pyx_t_17 = (__Pyx_div_long((9 * __pyx_v_PI), 8) <= __pyx_v_direction);
      if (__pyx_t_17) {
        __pyx_t_17 = (__pyx_v_direction < __Pyx_div_long((11 * __pyx_v_PI), 8));
      }
      __pyx_t_16 = (__pyx_t_17 != 0);
      __pyx_t_15 = __pyx_t_16;
 ...
 */
      __pyx_t_16 = (__Pyx_div_long((3 * __pyx_v_PI), 8) <= __pyx_v_direction);
      if (__pyx_t_16) {
        __pyx_t_16 = (__pyx_v_direction < __Pyx_div_long((5 * __pyx_v_PI), 8));
      }
      __pyx_t_17 = (__pyx_t_16 != 0);
      if (!__pyx_t_17) {
      } else {
      ...
      __pyx_t_17 = (__Pyx_div_long((11 * __pyx_v_PI), 8) <= __pyx_v_direction);
      if (__pyx_t_17) {
        __pyx_t_17 = (__pyx_v_direction < __Pyx_div_long((13 * __pyx_v_PI), 8));
      }
      __pyx_t_16 = (__pyx_t_17 != 0);
      __pyx_t_15 = __pyx_t_16;
 ...
 */
      ...
      __pyx_t_16 = (((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_gradient_magnitude.data + __pyx_t_13 * __pyx_v_gradient_magnitude.strides[0]) ) + __pyx_t_12 * __pyx_v_gradient_magnitude.strides[1]) ))) >= __pyx_v_before_pixel) != 0);
      if (__pyx_t_16) {
      } else {
        __pyx_t_15 = __pyx_t_16;
      ...
      __pyx_t_16 = (((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_gradient_magnitude.data + __pyx_t_12 * __pyx_v_gradient_magnitude.strides[0]) ) + __pyx_t_13 * __pyx_v_gradient_magnitude.strides[1]) ))) >= __pyx_v_after_pixel) != 0);
      __pyx_t_15 = __pyx_t_16;
 ...
 */
        ...
        __pyx_t_5 = __Pyx_PyInt_From_unsigned_char((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_gradient_magnitude.data + __pyx_t_13 * __pyx_v_gradient_magnitude.strides[0]) ) + __pyx_t_12 * __pyx_v_gradient_magnitude.strides[1]) )))); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_row); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __pyx_t_3 = __Pyx_PyInt_From_int(__pyx_v_col); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        ...
        __pyx_t_4 = 0;
        __pyx_t_3 = 0;
        if (unlikely(PyObject_SetItem(__pyx_v_output, __pyx_t_2, __pyx_t_5) < 0)) __PYX_ERR(0, 42, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *     return output
 */
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_v_output, __pyx_n_s_astype); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_GetModuleGlobalName(__pyx_t_3, __pyx_n_s_np); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_ubyte); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = NULL;
 ...
 *     return output             # <<<<<<<<<<<<<<
 */
  __pyx_t_18 = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(__pyx_v_output, PyBUF_WRITABLE); if (unlikely(!__pyx_t_18.memview)) __PYX_ERR(0, 45, __pyx_L1_error)
  __pyx_r = __pyx_t_18;
 ...
 */
  ...
  __Pyx_AddTraceback("suppression.non_max_suppression", __pyx_clineno, __pyx_lineno, __pyx_filename);
  goto __pyx_L2;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_11suppression_1non_max_suppression(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_11suppression_1non_max_suppression(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_gradient_magnitude = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_gradient_direction = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("non_max_suppression (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_gradient_magnitude,&__pyx_n_s_gradient_direction,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gradient_magnitude)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_gradient_direction)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("non_max_suppression", 1, 2, 2, 1); __PYX_ERR(0, 9, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "non_max_suppression") < 0)) __PYX_ERR(0, 9, __pyx_L3_error)
      }
    ...
    __pyx_v_gradient_magnitude = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_gradient_magnitude.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_gradient_direction = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_gradient_direction.memview)) __PYX_ERR(0, 9, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("non_max_suppression", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 9, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("suppression.non_max_suppression", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_11suppression_non_max_suppression(__pyx_self, __pyx_v_gradient_magnitude, __pyx_v_gradient_direction);
...
static PyObject *__pyx_pf_11suppression_non_max_suppression(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_gradient_magnitude, __Pyx_memviewslice __pyx_v_gradient_direction) {
  ...
  if (unlikely(!__pyx_v_gradient_magnitude.memview)) { __Pyx_RaiseUnboundLocalError("gradient_magnitude"); __PYX_ERR(0, 9, __pyx_L1_error) }
  if (unlikely(!__pyx_v_gradient_direction.memview)) { __Pyx_RaiseUnboundLocalError("gradient_direction"); __PYX_ERR(0, 9, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_11suppression_non_max_suppression(__pyx_v_gradient_magnitude, __pyx_v_gradient_direction, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 9, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_gradient_magnitude, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_gradient_direction, 1);
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "suppression.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "suppression._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"non_max_suppression", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_11suppression_1non_max_suppression, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_suppression(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_suppression},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_gradient_direction, __pyx_k_gradient_direction, sizeof(__pyx_k_gradient_direction), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC initsuppression(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC initsuppression(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_suppression(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_suppression(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_suppression(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'suppression' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_suppression(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("suppression", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_suppression) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "suppression")) {
      if (unlikely(PyDict_SetItemString(modules, "suppression", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init suppression", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init suppression");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
