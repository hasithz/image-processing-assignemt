...
static __Pyx_memviewslice __pyx_f_9threshold_threshold(__Pyx_memviewslice, int, int __pyx_skip_dispatch); /*proto*/
...
static PyObject *__pyx_pf_9threshold_threshold(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, int __pyx_v_val1); /* proto */
 ...
 * 
 * cpdef unsigned char [:, :] threshold(unsigned char [:, :] image,int val1):             # <<<<<<<<<<<<<<
 *     # set the variable extension types
 *     cdef int x, y, w, h
 */

static PyObject *__pyx_pw_9threshold_1threshold(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static __Pyx_memviewslice __pyx_f_9threshold_threshold(__Pyx_memviewslice __pyx_v_image, int __pyx_v_val1, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_w;
  int __pyx_v_h;
 ...
 *     for y in range(0, h):             # <<<<<<<<<<<<<<
 *         for x in range(0, w):
 *             image[y, x] = 255 if image[y, x] >= val1 else 0
 */
  __pyx_t_1 = __pyx_v_h;
  __pyx_t_2 = __pyx_t_1;
 ...
 */
      ...
      if ((((*((unsigned char *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_image.data + __pyx_t_8 * __pyx_v_image.strides[0]) ) + __pyx_t_9 * __pyx_v_image.strides[1]) ))) >= __pyx_v_val1) != 0)) {
        __pyx_t_7 = 0xFF;
      } else {
        __pyx_t_7 = 0;
      }
...
static PyObject *__pyx_pw_9threshold_1threshold(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("threshold (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_val1)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("threshold", 1, 2, 2, 1); __PYX_ERR(0, 5, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "threshold") < 0)) __PYX_ERR(0, 5, __pyx_L3_error)
      }
    ...
    __pyx_v_image = __Pyx_PyObject_to_MemoryviewSlice_dsds_unsigned_char(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_image.memview)) __PYX_ERR(0, 5, __pyx_L3_error)
    __pyx_v_val1 = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_val1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 5, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("threshold", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 5, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("threshold.threshold", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9threshold_threshold(__pyx_self, __pyx_v_image, __pyx_v_val1);
...
static PyObject *__pyx_pf_9threshold_threshold(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_image, int __pyx_v_val1) {
  ...
  __pyx_t_1 = __pyx_f_9threshold_threshold(__pyx_v_image, __pyx_v_val1, 0); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 5, __pyx_L1_error)
  __pyx_t_2 = __pyx_memoryview_fromslice(__pyx_t_1, 2, (PyObject *(*)(char *)) __pyx_memview_get_unsigned_char, (int (*)(char *, PyObject *)) __pyx_memview_set_unsigned_char, 0);; if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 5, __pyx_L1_error)
